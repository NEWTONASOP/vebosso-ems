  ...
  return (
    <View style={[styles.wrap, { height }]}>
      <WebView
        ref={webRef}
        originWhitelist={['*']}
        // A real origin makes tile requests carry a Referer, which OSM's
        // servers require (without it they answer "Access blocked").
        source={{ html, baseUrl: 'https://vebosso-ems.vercel.app/' }}
        style={styles.web}
